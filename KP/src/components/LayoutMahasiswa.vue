      ...
      <li class="nav-item" v-if="!sidebarCollapsed">
        ...
        <div v-if="tugasAkhirOpen" id="collapseTugas" class="collapse show">
          <div class="bg-transparent py-2 collapse-inner rounded">
            <router-link class="collapse-item" to="/tugas-akhir/outline">Outline Skripsi</router-link>
            <router-link class="collapse-item" to="/tugas-akhir/pengajuan-proposal">Pengumpulan Proposal</router-link>
            <router-link class="collapse-item" to="/tugas-akhir/seminar-proposal">Seminar Proposal</router-link>
            <router-link class="collapse-item" to="/tugas-akhir/pengajuan-skripsi">Pengumpulan Skripsi</router-link>
            <router-link class="collapse-item" to="/tugas-akhir/seminar-hasil">Seminar Hasil</router-link>
            <router-link class="collapse-item" to="/tugas-akhir/sidang-skripsi">Sidang Skripsi</router-link>
          </div>
        </div>
      </li>
